...
parser.add_argument(
    "--predictions", "-p", type=str, required=True, help="Path to predicted transcriptions"
)
parser.add_argument(
    "--ground_truth", "-g", type=str, required=True, help="Path to ground truth transcriptions"
)
